...
as
	select DT.DocumentTypeName, D.DocumentName, D.Tariff, D.[Percent], D.Apiece, D.Comment
	from [dbo].[Documents] D inner join [dbo].[DocumentTypes] DT on D.DocumentTypeID = DT.DocumentTypeID 
go
